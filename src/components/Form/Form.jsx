    ...
    function handleFormSubmit(e) {
        ...
        if (emailArr[0].length < 2) {
            Notiflix.Notify.warning(
                "Email must contain 2 symbols before '@'!",
                {
                    timeout: 1500,
                },
            );
    ...
    return (
        <div className={s.formContainer}>
            ...
            <button className={s.googleBtn}>
                ...
                >
                    <GoogleIconHome />{" "}
                    <span className={s.btn__span}>Google</span>
                </a>
            </button>
            <p className={s.help}>
            ...
            <form action="" onSubmit={handleFormSubmit} className={s.form}>
                <p className={s.prompt}>
                    <span className={isPromptActive ? s.warning : s.hidden}>
                        *
                    </span>
                    Email:
                </p>
                ...
                <div className={s.buttonContainer}>
                    ...
                    <button
                        ...
                        className={
                            isRegisterBtnActive ? s.activeBtn : s.authBtn
                        }
                        onClick={switchButtons}
                    >
                        Sign up
